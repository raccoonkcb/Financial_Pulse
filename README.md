...
![금융박동 메인화면](./view/photo/금융박동 메인화면.png)
...
![데이터 파이프라인 다이어그램](./view/photo/데이터 파이프라인.png)
...
![NER 모델 적용 비교](./view/photo/NER 모델 적용.png)
...
![키워드 최종 적용 화면](./view/photo/키워드 적용.png)
...
![감성화면 상세 그래프](./view/photo/감성화면 상세.png)
